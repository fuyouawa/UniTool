...
namespace UniTool.Editor.Window
{
    ...
    internal class EditorIconsWindow : EditorWindow
    {
        ...
        public static string[] ico_list =
        {
            ...
            "AvatarController.LayerSelected", "BodyPartPicker", "BodySilhouette", "DotFill", "DotFrame",
            "DotFrameDotted",
            "DotSelection", "Head", "HeadIk", "HeadZoom", "HeadZoomSilhouette", "LeftArm", "LeftFeetIk", "LeftFingers",
            "LeftFingersIk", "LeftHandZoom", "LeftHandZoomSilhouette", "LeftLeg", "MaskEditor_Root", "RightArm",
            "RightFeetIk",
            "RightFingers", "RightFingersIk", "RightHandZoom", "RightHandZoomSilhouette", "RightLeg", "Torso",
            "AvatarPivot",
            "back", "back@2x", "beginButton-On", "beginButton", "blendKey", "blendKeyOverlay", "blendKeySelected",
            "blendSampler", "blueGroove", "BuildSettings.Android", "BuildSettings.Android.Small",
            ...
            "Collab.BuildFailed", "Collab.BuildSucceeded", "Collab.FileAdded", "Collab.FileConflict",
            "Collab.FileDeleted",
            "Collab.FileIgnored", "Collab.FileMoved", "Collab.FileUpdated", "Collab.FolderAdded",
            "Collab.FolderConflict",
            "Collab.FolderDeleted", "Collab.FolderIgnored", "Collab.FolderMoved", "Collab.FolderUpdated",
            "Collab.NoInternet", "Collab", "Collab.Warning", "CollabConflict", "CollabError", "CollabNew",
            "CollabOffline",
            ...
            "curvekeyframeselectedoverlay", "curvekeyframesemiselectedoverlay", "curvekeyframeweighted",
            "CustomSorting",
            ...
            "d_P4_OutOfSync", "d_Particle Effect", "d_PauseButton On", "d_PauseButton", "d_PlayButton On",
            "d_PlayButton",
            ...
            "d_Preset.Context", "d_PreTextureAlpha", "d_PreTextureMipMapHigh", "d_PreTextureMipMapLow",
            "d_PreTextureRGB",
            "d_Profiler.Audio", "d_Profiler.CPU", "d_Profiler.FirstFrame", "d_Profiler.GPU", "d_Profiler.LastFrame",
            "d_Profiler.Memory", "d_Profiler.Network", "d_Profiler.NextFrame", "d_Profiler.Physics",
            "d_Profiler.PrevFrame",
            "d_Profiler.Record", "d_Profiler.Rendering", "d_Profiler.Video", "d_ProfilerColumn.WarningCount",
            "d_Project",
            ...
            "d_ToolHandlePivot", "d_tranp", "d_TransformTool On", "d_TransformTool", "d_tree_icon",
            "d_tree_icon_branch",
            ...
            "d_TreeEditor.Leaf", "d_TreeEditor.LeafFreeHand On", "d_TreeEditor.LeafFreeHand",
            ...
            "LookDevObjRotation", "LookDevObjRotation@2x", "LookDevPaneOption", "LookDevPaneOption@2x",
            "LookDevResetEnv",
            ...
            "P4_BlueLeftParenthesis", "P4_BlueRightParenthesis", "P4_CheckOutLocal", "P4_CheckOutRemote",
            "P4_Conflicted",
            ...
            "PreMatLight0", "PreMatLight1", "PreMatQuad", "PreMatSphere", "PreMatTorus", "Preset.Context",
            "PreTextureAlpha",
            "PreTextureArrayFirstSlice", "PreTextureArrayLastSlice", "PreTextureMipMapHigh", "PreTextureMipMapLow",
            "PreTextureRGB", "AreaLight Gizmo", "AreaLight Icon", "Assembly Icon", "AssetStore Icon",
            "AudioMixerView Icon",
            ...
            "d_AudioMixerView Icon", "d_CollabChanges Icon", "d_CollabChangesConflict Icon",
            ...
            "BillboardRenderer Icon", "BoxCollider Icon", "BoxCollider2D Icon", "BuoyancyEffector2D Icon",
            "Camera Icon",
            ...
            "d_GameObject Icon", "d_LightProbeProxyVolume Icon", "d_ParticleSystem Icon",
            ...
            "Mesh Icon", "MeshCollider Icon", "MeshFilter Icon", "MeshRenderer Icon", "Motion Icon",
            "MovieTexture Icon",
            ...
            "Shader Icon", "ShaderVariantCollection Icon", "SkinnedMeshRenderer Icon", "Skybox Icon",
            "SliderJoint2D Icon",
            "TrackedPoseDriver Icon", "SphereCollider Icon", "SpringJoint Icon", "SpringJoint2D Icon", "Sprite Icon",
            "SpriteMask Icon", "SpriteRenderer Icon", "StreamingController Icon", "StyleSheet Icon",
            ...
            "TilemapRenderer Icon", "d_TimelineAsset Icon", "TimelineAsset Icon", "TrailRenderer Icon",
            "Transform Icon",
            ...
            "GraphicRaycaster Icon", "GridLayoutGroup Icon", "HorizontalLayoutGroup Icon", "Image Icon",
            "InputField Icon",
            "LayoutElement Icon", "Mask Icon", "Outline Icon", "PositionAsUV1 Icon", "RawImage Icon", "RectMask2D Icon",
            "Scrollbar Icon", "ScrollRect Icon", "Selectable Icon", "Shadow Icon", "Slider Icon", "Text Icon",
            "Toggle Icon",
            ...
            "Profiler.GPU", "Profiler.Instrumentation", "Profiler.LastFrame", "Profiler.Memory",
            ...
            "Profiler.Video", "ProfilerColumn.WarningCount", "Project", "RectTool On", "RectTool",
            ...
            "SceneViewOrtho", "SceneViewRGB", "ScrollShadow", "Settings", "SettingsIcon",
            ...
            "StepButton On", "StepButton", "StepLeftButton-On", "StepLeftButton", "sticky_arrow", "sticky_p4",
            "sticky_skin",
            ...
            "TestPassed", "TestStopwatch", "TimelineClipBG", "TimelineClipFG", "TimelineDigIn",
            "TimelineEditModeMixOFF",
            "TimelineEditModeMixON", "TimelineEditModeReplaceOFF", "TimelineEditModeReplaceON",
            ...
            "TransformTool", "tree_icon", "tree_icon_branch", "tree_icon_branch_frond", "tree_icon_frond",
            "tree_icon_leaf",
            ...
            "TreeEditor.Refresh", "TreeEditor.Trash", "TreeEditor.Wind On", "TreeEditor.Wind",
            ...
            "UnityEditor.VersionControl", "UnityLogo", "UnityLogoLarge", "UpArrow", "vcs_add", "vcs_branch",
            "vcs_change",
            "vcs_check", "vcs_delete", "vcs_document", "vcs_edit", "vcs_incoming", "vcs_integrate", "vcs_local",
            "vcs_lock",
            "vcs_refresh", "vcs_sync", "vcs_unresolved", "vcs_update", "VerticalSplit", "ViewToolMove On",
            "ViewToolMove",
            ...
            "WaitSpin02", "WaitSpin03", "WaitSpin04", "WaitSpin05", "WaitSpin06", "WaitSpin07", "WaitSpin08",
            "WaitSpin09",
            ...
            "AvatarInspector/RightArm", "AvatarInspector/LeftArm", "AvatarInspector/RightLeg",
